...
class CommandList extends Component<CommandListProps, CommandListState> {
  ...
  render(): React.ReactNode {
    ...
    return (
      <div className="items shadow-lg flex flex-col p-1.5 rounded-[1.125rem] items-stretch min-w-60 bg-[rgb(25,25,26)]">
        {items.map((item, index) => {
          return (
            <button
              className={`item text-left hover:bg-[rgb(45,45,47)] p-2 rounded-xl text-sm font-medium transition-all duration-200 cursor-pointer text-[rgba(247,247,253,0.64)] hover:text-[rgba(255,255,255,0.96)] flex items-center gap-1`}
              key={index}
